...
def static_size_of(typ: type | object, /) -> algopy.UInt64 | None:
    ...
    if hasattr(typ, "_type_info") or isinstance(typ, _TypeInfo):
        ...
        if size is not None:
            return _algopy_testing.UInt64(size)

    # Fixed-size types
    fixed_sizes = {_algopy_testing.UInt64: 8, Account: 32, Application: 8, Asset: 8, bool: 8}
    ...
    if is_tuple:
        ...
        return static_size_of(_TupleTypeInfo(type_infos))
